    ...
    private class ReadWriteThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    String decryptedString = AESCrypt.decrypt("lololo", message);
                    byte[] buffer2 = decryptedString.getBytes();
        ...
        public void write(byte[] buffer) {
            try {
                ...
                String messege = new String(buffer);
                String encryptedMsg = AESCrypt.encrypt("lololo", messege);

                byte[] buffer2 = encryptedMsg.getBytes();
